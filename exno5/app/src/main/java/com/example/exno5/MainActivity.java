...
//                .setIcon(IconCompat.createWithResource(this, R.drawable.index))
    ...
    private void notificationWithImage() {
        Person bot = new Person.Builder()
                ...
                .setBot(true) .build();
        Uri uri = Uri.parse("android.resource://com.journaldev.androidpnotifications/drawable/"+R.drawable.ic_launcher_background);
    ...
    private void notificationWithGroupConvo()
    {
        ...
        new NotificationCompat.MessagingStyle(bot)
                ...
                .setGroupConversation(true).setConversationTitle("Sample Conversation")
                        .setBuilder(builder);
    ...
    private void notificationSemantic()
    {
        ...
        NotificationCompat.Action replyAction =
                new NotificationCompat.Action.Builder(
                        R.drawable.ic_launcher_background, "MARK READ", pendingIntent)
